...
class BinarySearchTree:
    ...
    def find_next_largest(self, data):
        ...
        while current_node is not None:
            # If the data of the current node is greater than the given data
        ...
        # Return the data of the successor if it is not None, else return None
    ...
    def find_next_smallest(self, data):
        ...
        # Traverse the tree
        while current_node is not None:
            # If the data of the current node is less than the given data
            if current_node.data < data:
                # Update the successor to the current node
                successor = current_node
                # Move to the right subtree
...
print(bst.find_next_largest(10))
print(bst.find_next_smallest(10))
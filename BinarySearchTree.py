...
print("Using the print_tree function")
bst.print_tree()

print()
print("Using the __contains__ function")
if 7 in bst:
    print("Yep, we found the number 7.")

if 77 not in bst:
    print ("Nope, 77 is not in the tree.")

print()
print("Using the __iter__ method")
for number in bst:
    print(number)

print()
for number in reversed(bst):
    print(number)
print("And that was using the __reversed__ method")
